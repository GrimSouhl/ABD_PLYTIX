...
los sinonimos deben asignarse a un usuario en concreto no se pueden asignar a un rol

asignarle a las excepciones numeros para poder identificarlas
pragma exception_init(identificacion_invalida, -20001);
asignar numeros distintos por errores, numeros enteros
